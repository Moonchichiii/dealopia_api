...
SUSTAINABILITY_KEYWORDS = [
    "eco-friendly", "sustainable", "organic", "fair trade", "recycled",
    "biodegradable", "carbon neutral", "zero waste", "ethical", "green",
    "upcycled", "plant-based", "vegan", "renewable", "local"
]
...
class GooglePlacesService:
    ...
    def search(cls, 
               ...
               radius_km: float = 10,
               min_sustainability: float = 0) -> List[Dict]:
        ...
        try:
            ...
            results.sort(key=lambda x: (x["sustainability_score"], -x.get("distance", 1000)), reverse=True)
    ...
    def _calculate_sustainability_score(cls, place: Dict) -> float:
        ...
        # European focus
        european_locations = ["germany", "france", "uk", "united kingdom", "spain", 
    ...
    @staticmethod
    def _compute_distance(lat1: float, lng1: float, lat2: float, lng2: float) -> Optional[float]:
