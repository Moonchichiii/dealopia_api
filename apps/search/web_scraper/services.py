...
SUSTAINABILITY_KEYWORDS = [
    ...
    "upcycled", "plant-based", "cruelty-free", "vegan", "compostable",
    "renewable", "energy efficient", "locally sourced", "b corp",
]
...
class WebScraperService:
    ...
    def analyze_shop_website(url: str) -> Dict:
        ...
        try:
            with sync_playwright() as p:
                ...
                sustainability_score = WebScraperService._analyze_sustainability(soup, html, url)
    ...
    def _analyze_sustainability(soup, html: str, base_url: str) -> Dict:
        ...
        for img in soup.find_all('img'):
            ...
            if any(keyword in alt_text or keyword in src for keyword in SUSTAINABILITY_KEYWORDS):
                img_count += 1
